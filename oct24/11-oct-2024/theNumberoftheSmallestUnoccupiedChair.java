...
public class theNumberoftheSmallestUnoccupiedChair {
    ...
    Name Of The Problem :- 1942. The Number of the Smallest Unoccupied Chair
...
class Solution {
    public int smallestChair(int[][] times, int targetFriend) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (free.isEmpty()) {
                occupied.add(new int[] { depart, chairNo });
                ...
                occupied.add(new int[] { depart, leastChairAvailable });
            }
        }
